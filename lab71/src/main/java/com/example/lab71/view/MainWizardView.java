...
public class MainWizardView extends VerticalLayout {
    private final TextField fNameTxt;
    private final NumberField dollarTxt;
    private final ComboBox position;
    private final ComboBox school;
    private final ComboBox house;
    ...
    public MainWizardView() {
        ...
        this.dollarTxt = new NumberField("Dollars");
        ...
        this.createBtn.addClickListener(event -> {
            ...
            formData.add("money", String.valueOf(this.dollarTxt.getValue()));
    ...
    public void setData(int i) {
        ...
        this.dollarTxt.setValue(wz.getMoney());
